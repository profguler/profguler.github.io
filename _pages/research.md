...
<div class="research-intro">
  ...
  <p>
  My research integrates analytical mechanics, computational mechanics, finite element analysis, and engineering simulation to address challenging problems in contact mechanics, thin films, crashworthiness, thermal sciences, structural stability, fracture mechanics, and engineering design.
  </p>
...
<!-- ========================================================= -->
<!-- CARD 2: THIN FILM MECHANICS AND SURFACE EFFECTS          -->
<!-- ========================================================= -->
...
<!-- ========================================================= -->
<!-- CARD 3: CRASHWORTHINESS AND LIGHTWEIGHT STRUCTURES       -->
<!-- ========================================================= -->
...
<a class="research-card" href="/research/crashworthiness/">
  ...
  <img
    ...
    alt="Corrugated multi-cell crash boxes before and after crushing"
  >
...
<a class="research-card" href="/research/structural-stability/">
  ...
  <div class="research-card-body">
    ...
    <p>
    Buckling, Vierendeel action, nonlinear behavior, perforated beams, thin-walled members, stiffener design, and practical stability formulations.
    </p>
...
<a class="research-card" href="/research/peridynamics/">
  ...
  <div class="research-card-body">
    ...
    <h2>Peridynamics and Computational Fracture</h2>

    <p>
    Nonlocal computational methods for crack initiation, propagation, composite delamination, interface failure, and fracture without predefined crack paths.
    </p>
...
<a class="research-card" href="/publications/">
  ...
  <div class="research-card-body">
    ...
    <p>
    Peer-reviewed journal articles and scholarly contributions across computational mechanics, contact mechanics, thin films, fracture, crashworthiness, thermal interfaces, and structural engineering.
    </p>
